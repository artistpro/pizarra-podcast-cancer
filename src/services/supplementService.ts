...
export const FALLBACK_SUPPLEMENT_IMAGE = "https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=1200&h=675&q=85";

// ============================================================================
// CATÁLOGO MAESTRO: 24 SUPLEMENTOS CLÍNICOS E INTEGRATIVOS
// Basado en el Protocolo del Dr. Pete Sulack y Evidencia en Oncología Integrativa
// ============================================================================
export const MASTER_SUPPLEMENTS_BANK: SupplementData[] = [
  // --------------------------------------------------------------------------
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1582979512210-99b6a53386f9?auto=format&fit=crop&w=1200&h=675&q=85",
    keyBenefits: [
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?auto=format&fit=crop&w=1200&h=675&q=85",
    keyBenefits: [
  ...
  // --------------------------------------------------------------------------
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=1200&h=675&q=85",
    keyBenefits: [
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1550258987-190a2d41a8ba?auto=format&fit=crop&w=1200&h=675&q=85",
    keyBenefits: [
...
/**
 * Retorna las 4 fichas de suplementos correspondientes al día de hoy,
 * rotando continuamente a través de las 24 fichas del catálogo maestro.
 */
export function getDailySupplements(dayNum?: number, count = 4): SupplementData[] {
  const day = dayNum ?? getDayOfYear();
  const total = MASTER_SUPPLEMENTS_BANK.length; // 24
  const offset = (day * 2) % total;

  const result: SupplementData[] = [];
  for (let i = 0; i < count; i++) {
    result.push(MASTER_SUPPLEMENTS_BANK[(offset + i) % total]);
  }
  return result;
}

/**
 * Retorna todas las 24 variantes del catálogo maestro
 */
export function getAllSupplements(): SupplementData[] {
  return [...MASTER_SUPPLEMENTS_BANK];
}
